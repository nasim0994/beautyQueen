...
const Banner = () => {
  return (
    <div className="bg-[url('https://tailwindmaxui.netlify.app/static/media/installation.50c59fdd.9713bc44d9403301b053.jpg')] bg-no-repeat bg-cover py-2 lg:h-max">
      <div className="w-[90] xl:w-[1280px] mx-auto h-[420px]">
